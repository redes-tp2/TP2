...
PROGRAM = "secret" # replace with the current P4 program

print("Starting setup for {prog}".format(prog=PROGRAM))

exec("p4 = bfrt.{prog}.pipe".format(prog=PROGRAM))  # access to the program-specific table config
...
port_map = [ # port_name | mac | speed
    # Pipeline 1
    ("1/0", "00:00:00:00:00:01", "BF_SPEED_100G"),
    ("2/0", "00:00:00:00:00:02", "BF_SPEED_100G"),
    ("3/0", "00:00:00:00:00:03", "BF_SPEED_100G"),
    ("4/0", "00:00:00:00:00:04", "BF_SPEED_100G"),
]
...
SPEED_TO_LANES = {'BF_SPEED_10G': 1, 'BF_SPEED_25G': 1, 'BF_SPEED_50G': 2, 'BF_SPEED_100G': 4}
def get_lanes(speed): 
